...
![Fig 1 - A `GET` request being sent to *[api.chucknorris.io/jokes/random](https://api.chucknorris.io/jokes/random)* with one query parameter](Untitled-2.png)

Fig 1 - A `GET` request being sent to *[api.chucknorris.io/jokes/random](https://api.chucknorris.io/jokes/random)* with one query parameter
